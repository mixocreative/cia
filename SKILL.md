...
2a. §0.9 cross-boundary invariant sweeps S1–S17 (integration-level / emergent defects): one line each — "swept, 0 findings, N sites" or ❌ finding ref. Missing line = sweep not done. **S15 (four-corner end-to-end walk) carries its own table and cannot be reported as a single line.**
