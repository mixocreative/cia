...
S20 asks whether the detectors are looking. **S21 asks it of the test suite**, which is the detector everything else is trusted on. Six shapes, the first four confirmed in one codebase in one day, the sixth days later in the same one:
